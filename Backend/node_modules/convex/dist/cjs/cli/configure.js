...
async function selectNewProject(ctx, chosenConfiguration, config) {
  ...
  await (0, import_codegen.doInitialCodegen)(ctx, { init: true });
...
async function selectExistingProject(ctx, chosenConfiguration, config) {
  ...
  (0, import_log.showSpinner)(`Reinitializing project ${projectSlug}...
`);
  await (0, import_codegen.doInitialCodegen)(ctx, { init: false });
